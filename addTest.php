...
<!-- icons -->
	<div class="banner-bottom" id="about">
		<div class="container">
			<p class="sub_t_agileits"><b><u>Add a new Test</u></b></p>

			<div class="book-appointment">
				<form action="addTest_proc.php" method="post">
					<div class="left-agileits-w3layouts same">
						<div class="gaps">
							<p>Test Id</p>
							<input type="text" name="t_id" placeholder="" required=""/>
						</div>	
						<div class="gaps">
							<p>Patient Id</p>
							<input type="text" name="pat_id" placeholder="" required=""/>
						</div>	
						<div class="gaps">	
						...
						<div class="gaps">
							<p>Test Master Id</p>
							<input type="text" name="tm_id" placeholder="" required="" />
						</div>	
					</div>
