...
$query = "SELECT pat_id, tm_id, test_date 
			FROM test 
			WHERE t_id = $t_id";
...
<!-- icons -->
	<div class="banner-bottom" id="about">
		<div class="container">
			<p class="sub_t_agileits"><b><u>Modify Test Details</u></b></p>

			<div class="book-appointment">
				<form action="modTest_proc.php" method="post">
					<div class="left-agileits-w3layouts same">
						<div class="gaps">
							<p>Test Id</p>
							<input type="text" name="t_id" value="<?php echo $t_id ?>" placeholder="" required="" readonly/>
						</div>	
						<div class="gaps">
							<p>Patient Id</p>
							<input type="text" name="pat_id" value="<?php echo $pat_id ?>" placeholder="" required=""/>
						</div>	
						<div class="gaps">	
							<p>Test Master Id</p>
							<input type="text" name="tm_id" value="<?php echo $tm_id ?>" placeholder="" required=""/>
						</div>
						<div class="gaps">
							<p>Test Date</p>
							<input type="text" name="test_date" value="<?php echo $test_date ?>" placeholder="" required="" />
						</div>	
					</div>
					<div class="clearfix"></div>
						<input type="submit" value="Modify Test">
				</form>
			</div>
		</div>
	</div>
