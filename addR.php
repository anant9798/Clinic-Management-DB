...
// retrieve Room details for populating drop down
$queryT = "SELECT r_id, room_type FROM room ORDER BY r_id;";
...
{
  $optionRoom .= '<option value = "'.$rowT['r_id'].'">'.$rowT['room_type'].'</option>';
}
?>
	...
	<div class="services-breadcrumb">
		<div class="container">
			<ul>
				...
				<li>Admission Appointment<i>></i></li>
				<li>Add Admission Appointment</li>
			</ul>
		</div>
	</div>
<!-- //banner1 -->
<!-- icons -->
	<div class="banner-bottom" id="about">
		<div class="container">
			<p class="sub_t_agileits"><b><u>Add a new Admission Appointment</u></b></p>
				...
				<form action="addR_proc.php" method="post">
					<div class="left-agileits-w3layouts same">
						...
						<div class="gaps">
							...
							<input type="text" name="admit_date" placeholder="" required="" />
						</div>
						<div class="gaps">
							<p>No of Days</p>
							<input type="text" name="no_of_days" placeholder="" required="" />
						</div>	
					</div>
					<div class="clearfix"></div>
					<input type="submit" value="Add Admission Appointment">
				</form>
			</div>
		</div>
	</div>
