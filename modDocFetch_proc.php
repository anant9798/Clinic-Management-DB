...
$query = "SELECT doc_id, dept, doc_charge 
			FROM doctor 
...
<!-- icons -->
	<div class="banner-bottom" id="about">
		<div class="container">
			<p class="sub_t_agileits"><b><u>Modify Doctor Details</u></b></p>

			<div class="book-appointment">
				<form action="modDoc_proc.php" method="post">
					<div class="left-agileits-w3layouts same">
						<div class="gaps">
							<p>Doctor Id</p>
							<input type="text" name="doc_id" value="<?php echo $doc_id ?>" placeholder="" required="" readonly/>
						</div>	
						<div class="gaps">
							<p>Doctor Name</p>
							<input type="text" name="doc_name" value="<?php echo $doc_name ?>" placeholder="" required=""/>
						</div>	
						<div class="gaps">	
							<p>Department</p>
							<input type="text" name="dept" value="<?php echo $dept ?>" placeholder="" required=""/>
						</div>
						<div class="gaps">
							<p>Doctor Fees</p>
							<input type="text" name="doc_charge" value="<?php echo $doc_charge ?>" placeholder="" required="" />
						</div>	
					</div>
					<div class="clearfix"></div>
						<input type="submit" value="Modify Doctor">
				</form>
			</div>
		</div>
	</div>
