...
//Execute the query
$query = "SELECT t.t_id, t.pat_id, p.pat_name,t.test_date, tm.test_name, tm.test_charge
			FROM `test` t, `test_master` tm, `patient` p
			WHERE t.pat_id = p.pat_id and t.tm_id = tm.tm_id and p.pat_name = '$pat_name'
			ORDER BY t.t_id";
...
<!-- icons -->
	<div class="banner-bottom" id="about">
		<div class="container">
			<p class="sub_t_agileits"><b><u>Display Test Bill</u></b></p>
			...
			<div class="book-appointment">
				<table border="1" width="900" align="center">
					<tr>
						...
						<th style="text-align:center" width="80">Test Name</th>
						<th style="text-align:center" width="70">Test Date</th>		          
						<th style="text-align:center" width="60">Test Charge</th>
					</tr>
<?php
...
echo	'<tr> 
		<td align="center">'.$row['pat_id'].'</td>
           ...
           <td>'.$row['test_name'].'</td>		
           <td align="center">'.$row['test_date'].'</td>
		<td align="right">'.$row['test_charge'].'</td>
		</tr>';
}
?>
