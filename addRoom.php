...
<!-- icons -->
	<div class="banner-bottom" id="about">
		<div class="container">
			<p class="sub_t_agileits"><b><u>Add a new Room</u></b></p>

			<div class="book-appointment">
				<form action="addRoom_proc.php" method="post">
					<div class="left-agileits-w3layouts same">
						...
						<div class="gaps">
							<p>Room Type</p>
							<input type="text" name="room_type" placeholder="" required=""/>
						</div>	
						<div class="gaps">
							<p>Room Charge</p>
							<input type="text" name="room_charge" placeholder="" required="" />
						</div>	
					</div>
