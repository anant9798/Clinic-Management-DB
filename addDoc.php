...
<div class="container">
<p class="sub_t_agileits"><b><u>Add a new item</u></b></p>

<div class="book-appointment">
<form action="addDoc_proc.php" method="post">
<div class="left-agileits-w3layouts same">

<div class="gaps">
	<p>Doc_id</p>
	<input type="text" name="doc_id" placeholder="" required=""/>
</div>

<div class="gaps">
	<p>Doc Name</p>
	<input type="text" name="doc_name" placeholder="" required=""/>
</div>
...
<div class="gaps">
	<p>Doctor Charge</p>
	<input type="text" name="doc_charge" placeholder="" required="" />
</div>	
