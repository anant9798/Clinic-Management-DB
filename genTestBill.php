...
<!-- icons -->
	<div class="banner-bottom" id="about">
		<div class="container">
			<p class="sub_t_agileits"><b><u>Generate Test Bill</u></b></p>

			<div class="book-appointment">
				<form action="genTestBillFinal.php" method="post">
					...
					<div class="clearfix"></div>
						<input type="submit" value="Get Test Bill">
				</form>
			</div>
		</div>
	</div>
