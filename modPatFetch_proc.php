...
// create variable to capture incoming fields from addPat Form
...
$query = "SELECT pat_id,age,gender,phone,dor 
			FROM patient 
			WHERE pat_name = '$pat_name'";
...
<!-- icons -->
	<div class="banner-bottom" id="about">
		<div class="container">
			<p class="sub_t_agileits"><b><u>Modify Patient Details</u></b></p>

			<div class="book-appointment">
				<form action="modPat_proc.php" method="post">
					<div class="left-agileits-w3layouts same">
						<div class="gaps">
							<p>Patient Id</p>
							<input type="text" name="pat_id" value="<?php echo $pat_id ?>" placeholder="" required="" readonly/>
						</div>	
						<div class="gaps">
							<p>Patient Name</p>
							<input type="text" name="pat_name" value="<?php echo $pat_name ?>" placeholder="" required=""/>
						</div>
						<div class="gaps">	
							<p>Age</p>
							<input type="text" name="age" value="<?php echo $age ?>" placeholder="" required=""/>
						</div>
						<div class="gaps">
							<p>Phone</p>
					...
					<div class="right-agileinfo same">
						...
						<div class="gaps">
							<p>Registration Date (Enter as "yyyy-mm-dd")</p>
							<input type="text" name="dor" value="<?php echo $dor ?>" placeholder="" required="" />
						</div>	
						<div class="gaps">
							<p>Gender</p>
	...
	<div class="footer">
		<div class="container">
			<div class="col-md-6 agileits_w3layouts_copy_right">
				<p>&copy; 2017 Health Plus. All rights reserved.</p>
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
