...
//Execute the query
$query = "SELECT t.a_id, t.pat_id, p.pat_name,t.admit_date, d.room_type, 
				t.no_of_days, (t.no_of_days * d.room_charge) as charge
			FROM `admission` t, `room` d, `patient` p
			WHERE t.pat_id = p.pat_id and t.r_id = d.r_id and p.pat_name = '$pat_name'
			ORDER BY t.a_id";
	...
	<div class="services-breadcrumb">
		<div class="container">
			<ul>
				...
				<li>Admission Bill<i>></i></li>
				<li>Display Admission Bill</li>
			</ul>
		</div>
	</div>
<!-- //banner1 -->
<!-- icons -->
	<div class="banner-bottom" id="about">
		<div class="container">
			<p class="sub_t_agileits"><b><u>Display Admission Bill</u></b></p>

			<div class="book-appointment">
				<table border="1" width="900" align="center">
					<tr>
						<th style="text-align:center" width="80"><b>Patient Id</b></th>
						<th style="text-align:center" width="150">Patient Name</th>
						<th style="text-align:center" width="70">Patient Type</th>
						<th style="text-align:center" width="80">Room Type</th>
						<th style="text-align:center" width="70">Admit Date</th>
						<th style="text-align:center" width="70">No. of Days</th>
						<th style="text-align:center" width="60">Room Charge</th>
					</tr>
<?php
while($row = mysql_fetch_array($result)) 
{
echo	'<tr> 
		<td align="center">'.$row['pat_id'].'</td>
           <td>'.$row['pat_name'].'</td>
           <td align="center">In Patient</td>
           <td>'.$row['room_type'].'</td>		
           <td align="center">'.$row['admit_date'].'</td>
           <td align="center">'.$row['no_of_days'].'</td>
