...
//Execute the query
$result = mysql_query("CALL getGenderCount()");
	...
	<div class="services-breadcrumb">
		<div class="container">
			<ul>
				...
				<li>Gender Count<i>></i></li>
				<li>Display Gender Count</li>
			</ul>
		</div>
	</div>
<!-- //banner1 -->
<!-- icons -->
	<div class="banner-bottom" id="about">
		<div class="container">
			<p class="sub_t_agileits"><b><u>Display Genderwise Patient Count</u></b></p>

			<div class="book-appointment">
				<table border="1" width="900" align="center">
					<tr>
						<th style="text-align:center" width="80"><b>Gender</b></th>
						<th style="text-align:center" width="150">No of Patients</th>
					</tr>
<?php
