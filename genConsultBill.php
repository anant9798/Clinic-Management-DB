	...
	<div class="services-breadcrumb">
		<div class="container">
			<ul>
				...
				<li>Generate Consultation Bill</li>
			</ul>
		</div>
	</div>
<!-- //banner1 -->
<!-- icons -->
	<div class="banner-bottom" id="about">
		<div class="container">
			<p class="sub_t_agileits"><b><u>Generate Consultation Bill</u></b></p>

			<div class="book-appointment">
				<form action="genConsultBillFinal.php" method="post">
					...
					<div class="clearfix"></div>
						<input type="submit" value="Get Consultation Bill">
				</form>
			</div>
		</div>
	</div>
