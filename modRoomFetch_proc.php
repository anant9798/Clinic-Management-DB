...
$query = "SELECT room_type,room_charge 
			FROM room 
			WHERE r_id = $r_id";
	...
	<div class="banner-bottom" id="about">
		<div class="container">
			...
			<div class="book-appointment">
				<form action="modRoom_proc.php" method="post">
					<div class="left-agileits-w3layouts same">
						<div class="gaps">
							<p>Room Id</p>
							<input type="text" name="r_id" value="<?php echo $r_id ?>" placeholder="" required="" readonly/>
						</div>	
						<div class="gaps">
							<p>Room Type</p>
							<input type="text" name="room_type" value="<?php echo $room_type ?>" placeholder="" required=""/>
						</div>	
						<div class="gaps">
							<p>Room Charge</p>
							<input type="text" name="room_charge" value="<?php echo $room_charge ?>" placeholder="" required="" />
						</div>	
					</div>
					<div class="clearfix"></div>
						<input type="submit" value="Modify Room">
				</form>
			</div>
		</div>
	</div>
