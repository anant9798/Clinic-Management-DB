...
<!-- icons -->
	<div class="banner-bottom" id="about">
		<div class="container">
			<p class="sub_t_agileits"><b><u>Generate Admission Bill</u></b></p>

			<div class="book-appointment">
				<form action="genAdmitBillFinal.php" method="post">
					...
					<div class="clearfix"></div>
						<input type="submit" value="Get Admission Bill">
				</form>
			</div>
		</div>
	</div>
