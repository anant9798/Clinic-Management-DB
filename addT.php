...
$queryT = "SELECT tm_id, test_name FROM test_master ORDER BY tm_id;";
$resultT = mysql_query($queryT);
if (!$resultT) {
    die('Invalid Test query: ' . mysql_error());
}
$optionT = '';
 while($rowT = mysql_fetch_assoc($resultT))
{
  $optionT .= '<option value = "'.$rowT['tm_id'].'">'.$rowT['test_name'].'</option>';
}
?>
	...
	<div class="services-breadcrumb">
		<div class="container">
			<ul>
				...
				<li>Test Appointment<i>></i></li>
				<li>Add Test Appointment</li>
			</ul>
		</div>
	</div>
<!-- //banner1 -->
<!-- icons -->
	<div class="banner-bottom" id="about">
		<div class="container">
			<p class="sub_t_agileits"><b><u>Add a new Test Appointment</u></b></p>

			<div class="book-appointment">
				<form action="addT_proc.php" method="post">
					<div class="left-agileits-w3layouts same">
						...
						<div class="gaps">	
							<p>Test Name</p>
							<select id="tm_id" name="tm_id">
								<?php echo $optionT; ?>
							</select>
						</div>
						<div class="gaps">
							<p>Test Date (yyyy-mm-dd)</p>
							<input type="text" name="test_date" placeholder="" required="" />
						</div>	
					</div>
					<div class="clearfix"></div>
					<input type="submit" value="Add Test Appointment">
				</form>
			</div>
		</div>
	</div>
