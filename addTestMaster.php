...
<!-- icons -->
	<div class="banner-bottom" id="about">
		<div class="container">
			<p class="sub_t_agileits"><b><u>Add a new Test Master</u></b></p>

			<div class="book-appointment">
				<form action="addTestMaster_proc.php" method="post">
					<div class="left-agileits-w3layouts same">
						<div class="gaps">
							<p>Test Name</p>
							<input type="text" name="test_name" placeholder="" required=""/>
						</div>	
						<div class="gaps">
							<p>Test Charge</p>
							<input type="text" name="test_charge" placeholder="" required="" />
						</div>	
					</div>
