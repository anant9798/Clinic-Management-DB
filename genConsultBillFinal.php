...
//Execute the query
$query = "SELECT t.c_id, t.pat_id, p.pat_name,t.c_date, d.doc_name, d.doc_charge
			FROM `Consultation` t, `doctor` d, `patient` p
			WHERE t.pat_id = p.pat_id and t.doc_id = d.doc_id and p.pat_name = '$pat_name'
			ORDER BY t.c_id";
	...
	<div class="services-breadcrumb">
		<div class="container">
			<ul>
				...
				<li>Consultation Bill<i>></i></li>
				<li>Display Consultation Bill</li>
			</ul>
		</div>
	</div>
<!-- //banner1 -->
<!-- icons -->
	<div class="banner-bottom" id="about">
		<div class="container">
			<p class="sub_t_agileits"><b><u>Display Consultation Bill</u></b></p>
			...
			<div class="book-appointment">
				<table border="1" width="900" align="center">
					<tr>
						...
						<th style="text-align:center" width="80">Doctor Name</th>
						<th style="text-align:center" width="70">Consultation Date</th>		          
						<th style="text-align:center" width="60">Consultation Charge</th>
					</tr>
<?php
...
echo	'<tr> 
		<td align="center">'.$row['pat_id'].'</td>
           ...
           <td>'.$row['doc_name'].'</td>		
           <td align="center">'.$row['c_date'].'</td>
		<td align="right">'.$row['doc_charge'].'</td>
		</tr>';
}
?>
