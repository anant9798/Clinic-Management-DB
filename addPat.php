...
<!-- icons -->
	<div class="banner-bottom" id="about">
		<div class="container">
			<p class="sub_t_agileits"><b><u>Add a new Patient</u></b></p>

			<div class="book-appointment">
				<form action="addPat_proc.php" method="post">
					<div class="left-agileits-w3layouts same">
						...
						<div class="gaps">
							<p>Patient Name</p>
							<input type="text" name="pat_name" placeholder="" required=""/>
						</div>
						<div class="gaps">	
							<p>Age</p>
					...
					<div class="right-agileinfo same">
						<div class="gaps">
							...
							<input type="text" name="dor" placeholder="" required="" />
						</div>	
						<div class="gaps">
							<p>Gender</p>
